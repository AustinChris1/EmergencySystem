...
export default function GeneralDashboard() {
    ...
    const fetchAlerts = async () => {
        try {
            ...
            if (res.status === 200) {
                ...
                prepareChartData(GeneralAlerts);
                prepareAffectedAreas(GeneralAlerts); // Prepare data for the map
    ...
    // Filter General cases for the previous day, week, and month for comparison
            ...
            <div className={`flex-1 p-6 space-y-8 dark:bg-gray-900 dark:text-gray-200 transition-colors duration-300`}>
                <div className="flex justify-between items-center">
                    <h1 className="text-3xl font-extrabold text-blue-900 dark:text-gray-100">
                        Emergency Response General Service 🔥
                    </h1>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card>
                        <CardContent>
                            <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-100">General Alerts Over Time</h2>
                            {chartData.length > 0 ? (
                                <ReactApexChart
                            ...
                            <CardContent>
                                ...
                                {loading ? (<Loader />
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300">No active General alerts.</p>
                                    ) : (
                                    <>
                                        <div className="space-y-3">
